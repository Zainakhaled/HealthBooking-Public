...
export default {
  ...
  methods: {
    fetchAppointments() {
      fetch("https://o0poh36gp7.execute-api.eu-central-1.amazonaws.com/appointments")
        .then(res => res.json())
        .then(data => {
    ...
    updateStatus(appointment, newStatus) {
      ...
      const url = `https://o0poh36gp7.execute-api.eu-central-1.amazonaws.com/appointments`;
